...
export const COMPOSITION = {
  ...
  note:
    'この比較は、総務省「家計調査報告 家計収支編 2025年平均結果」の二人以上世帯の費目別支出をもとに、LIFE PLAN LAB のカテゴリに近い項目へ対応させた参考値です。これは生活費全体の比率ではなく、比較対象カテゴリ内の構成比です。保険料・サブスク・その他は費目の対応が不安定なため除外しています。良い悪いを示すものではなく、支出バランスを見る参考としてご覧ください。',
