...
export const COMPOSITION = {
  heading: '支出バランスの参考比較',
  intro:
    '金額そのものではなく、生活費の中でどのカテゴリの比率が大きいかを見る参考比較です。良い悪いを示すものではありません。',
  yourShare: 'あなたの比率',
  referenceShare: '参考構成比',
  foodEqualsOne: '食費を1とした場合',
  you: 'あなた',
  reference: '参考',
  ...
  foodHiddenNote: '食費の入力額が小さいため、食費=1の参考比率は表示していません。',
  ...
  note:
    'この比較は、総務省「家計調査報告 家計収支編 2025年平均結果」の二人以上世帯の費目別支出をもとに、LIFE PLAN LAB のカテゴリに近い項目へ対応させた参考値です。住宅ローン返済額、大学費用、保険料、サブスクなどは定義が一致しないため、良い悪いの判定ではなく、支出バランスを見る参考としてご覧ください。',
